...
class ProjectStreamInfoSpec extends Specification {
    ...
    def "constructor with row" () {
        ...
        then:
        psi.getClass().toString() == 'class it.zebco.ikan.alm.model.ProjectStreamInfo'
    }

    def "equality test true" () {
        when:
        ProjectStreamInfo psi1 = new ProjectStreamInfo(row1)
        ProjectStreamInfo psi2 = new ProjectStreamInfo(row1)
        println psi1.toString()
        println "Equals -> " + psi1.equals(psi1)
        then:
        psi1 == psi2
    }
